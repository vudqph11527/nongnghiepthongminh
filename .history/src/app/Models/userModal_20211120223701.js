...
module.exports = {
  create: (data, callback) => {
    db.query(
      `INSERT INTO users (username, password, phoneNumber) SELECT * FROM (SELECT ?,?,?) AS tmp WHERE NOT EXISTS (SELECT username, phoneNumber FROM users WHERE username = VALUES(username)) LIMIT 1;`,
